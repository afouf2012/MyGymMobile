package com.example.fitnessapp.Calculator;
...
public class ResultatBmi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultat_bmi);
        ...
        if (intbmi < 16) {
            mbmicategory.setText("3oud");
            mbackground.setBackgroundColor(Color.RED);
            mimageview.setImageResource(R.drawable.crosss);


        } else if (intbmi < 16.9 && intbmi > 16) {
            mbmicategory.setText("Dh3if");
           // mbackground.setBackgroundColor(#000000);
            mimageview.setImageResource(R.drawable.warning);

        } else if (intbmi < 18.4 && intbmi > 17) {
            mbmicategory.setText("Dhmayem");
           // mbackground.setBackgroundColor(R.color.halfwarn);
            ...
            mbmicategory.setText("Seyes");
            //mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.warning);

        } else if (intbmi < 34.9 && intbmi > 30) {

            mbmicategory.setText("Bou kerch");
           // mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.warning);

        } else {
            mbmicategory.setText("Botyy barcha");
